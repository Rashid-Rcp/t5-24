...
export default function ModalWraper({children, width="w-1/3", close=true, onClose}:ModalWrapperProps) {
  return (
    <div className={`fixed top-0 left-0 right-0 bottom-0 backdrop-blur-sm bg-white bg-opacity-30 flex items-center justify-center z-50`}>
            ...
            {close && (
                <div className="flex justify-end relative">
                    <button className="absolute -top-3 -right-2 rounded-full bg-white p-2 border" onClick={onClose}>
